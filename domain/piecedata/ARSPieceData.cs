...
public class ARSPieceData : IPieceData
{
    private static readonly IPiece[] Pieces = [
        ...
        new CustomPiece(
            new Block[][] {
                ...
                [new Block(1, 0), new Block(1, 1), new Block(1, -1), new Block(1, -2)],
            }, PieceType.I),
        new CustomPiece(
            new Block[][] {
                [new Block(0, 0), new Block(0, -1), new Block(1, -1), new Block(-1, -1)],
        ...
        new CustomPiece(
            new Block[][] {
                [new Block(1, 0), new Block(0, -1), new Block(1, -1), new Block(-1, -1)],
